...
function M.config()
    ...
    --  实现使用地方
    vim.keymap.set( "n", "gk", "<cmd>lua vim.lsp.buf.references()<CR>", {silent = true, noremap = true})
    --  使用接口
    vim.keymap.set( "n", "gl", "<cmd>lua vim.lsp.buf.implementation()<CR>", {silent = true, noremap = true})
    --  keymap.set
